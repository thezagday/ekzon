            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="demo-form-wrapper">
                        <form action="{!! route('add-child',['id' => $parent]) !!}" method="post" class="form form-horizontal" enctype="multipart/form-data">
                            <p>
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-control-1"></label>
                                <div class="col-sm-9">
                                    <a href="{!! route('children',['id' => $parent]) !!}"> Назад к каталогам</a>
                                </div>
                            </div>
                        </form>
                    </div>
