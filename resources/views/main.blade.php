...
@section('content')
    ...
    <div class="main-slider-slick main-slider-slick__theme-exon">
        ...
        <!-- <div class="main-slider-slick__item">
            <img class="main-slider__img" src="{!! $slide->img !!}"/>
        ...
        <div class="main-slider-slick__item">
            <div class="main-slider__img" style='background-image: url("{!! $slide->img !!}")'></div>
            <div class="main-slider__txt">
                <div class="main-slider__txt-title">{!! $_SESSION['lang'] == 'RU' ? $slide->title_ru:$slide->title_en !!}</div>
                <div class="main-slider__txt-text">{!! $_SESSION['lang'] == 'RU' ? $slide->content_ru:$slide->content_en !!}</div>
            </div>
                ...
                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="home-tab">
                    <div class="main-tabs-item">
                        <div class="main-tabs-item__text">
                            <div class="main-tabs-item__text-title">{!! $_SESSION['lang'] == 'RU' ? 'ОАО «ЭКЗОН»' : 'OJSC "EKZON"'!!} </div>
                            <div class="main-tabs-item__text-txt">{!! $_SESSION['lang'] == 'RU' ?
                                                                    'ОАО «ЭКЗОН» – современное фармацевтическое предприятие,производящее лекарственные средства и биологически активные добавки к пище. Диапазон выпускаемых продуктов превышает 100 наименований в различных формах выпуска: таблетки, леденцы, батончики, капсулы, сиропы, порошки и гранулы.' :
                                                                    'OJSC "EKZON" – a modern pharmaceutical enterprise that produces different kinds of medicines and dietary supplements. The range of products exceeds 100 items of products in various product forms: tablets, bars, capsules, syrups, powders and granules.' !!}
                            </div>
                            <div class="main-tabs-item__text-btn">
                                <a class="button button--gradient page-main__btn-to-catalog switch-on" href="/catalog">{!! $_SESSION['lang'] == 'RU' ? 'Смотреть в каталоге' : 'View in catalog' !!}</a>
                            </div>
                        </div>
                        <div class="main-tabs-item__slider">
                            ...
                            <div class="slider-slick-mult theme-exon">
                                @foreach ($new_products as $product)
                                    <!-- <a class="slider-slick-mult__item" href="/products/{!! $product->id !!}">
                                      <img class="slider-slick-mult__img" src="{!! asset($product->img) !!}"/>
                                    ...
                                    <a class="slider-slick-mult__item" href="/products/{!! $product->id !!}">
                                      <div class="slider-slick-mult__img" style="background-image: url('{!! asset($product->img) !!}');">
                                      </div>
                                      <div class="slider-slick-mult__txt">
                                        <div class="slider-slick-mult__title">{!! $_SESSION['lang'] == 'RU' ? $product->title_ru : $product->title_en !!}</div>
                                        <div class="slider-slick-mult__text">{!! $_SESSION['lang'] == 'RU' ? $product->short_desc_ru : $product->short_desc_en !!}</div>
                        ...
                        {{--<div class="main-tabs-item__text-btn">--}}
                            {{--<a class="button button--gradient page-main__btn-to-catalog switch-off" href="/catalog/{!! $catalog->subCatalogs->first()->id!!}">{!! $_SESSION['lang'] == 'RU' ? 'Смотреть в каталоге' : 'View in catalog' !!}</a>--}}
                        {{--</div>--}}
                    </div>
                </div>
                <?php $tab = 2; ?>
                        ...
                        <div class="tab-pane fade" id="tab{!! $tab !!}" role="tabpanel" aria-labelledby="home-tab">
                            <div class="main-tabs-item">
                                <div class="main-tabs-item__text">
                                    ...
                                    <div class="main-tabs-item__text-btn"><a class="button button--gradient page-main__btn-to-catalog switch-on" href="/catalog/{!! $parentCatalogs[$i]->subCatalogs->first()->id!!}">{!! $_SESSION['lang'] == 'RU' ? 'Смотреть в каталоге' : 'View in catalog' !!}</a>
                                    </div>
                                </div>
                                <div class="main-tabs-item__slider">
                                    <!-- Слайдер в табах-->
                                    <div class="slider-slick-mult theme-exon">
                                        ...
                                        <!-- <a class="slider-slick-mult__item" href="/products/{!! \App\Product::find($product->product_id)->id !!}">
                                          <img class="slider-slick-mult__img" src="{!! asset(\App\Product::find($product->product_id)->img) !!}"/>
                                          <div class="slider-slick-mult__txt">
                                        ...
                                        <a class="slider-slick-mult__item" href="/products/{!! \App\Product::find($product->product_id)->id !!}">
                                          <div class="slider-slick-mult__img" style="background-image: url('{!! asset(\App\Product::find($product->product_id)->img) !!}');"></div>
                                          <div class="slider-slick-mult__txt">
                                            <div class="slider-slick-mult__title">{!! $_SESSION['lang'] == 'RU' ? \App\Product::find($product->product_id)->title_ru : \App\Product::find($product->product_id)->title_en !!}</div>
                                            <div class="slider-slick-mult__text">{!! $_SESSION['lang'] == 'RU' ? \App\Product::find($product->product_id)->short_desc_ru : \App\Product::find($product->product_id)->short_desc_en !!}</div>
                                          </div>
                                ...
                                <div class="main-tabs-item__text-btn"><a class="button button--gradient page-main__btn-to-catalog switch-off" href="/catalog/{!! $catalog->subCatalogs->first()->id!!}">Смотреть в каталоге</a>
                                </div>
                            </div>
                        </div>
                    <?php $tab++?>
    ...
    <!-- Второй слайдер -->
    <div class="second-slider-slick main-slider-slick__theme-exon">
      @foreach ($secondSlider as $slide)
        <div class="main-slider__img" style='background-image: url("{!! $slide->img !!}")'></div>
        @endforeach
    </div>
    <!-- Второй слайдер -->
