                    ...
                    <div class="demo-form-wrapper">
                        <form action="add_catalog" method="post" class="form form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="list-group">
                                            <a class="list-group-item" href="/edit-child/{!! $item->id !!}">
                                                <div class="media">
                                            ...
                                            <a class="list-group-item" href="/delete-child/{{$item->id}}">
                                                <div class="media">
                                                    <div class="media-middle media-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-control-1"></label>
                                <div class="col-sm-9">
                                    <input type="button" class="btn-primary" id="input_btn" value="Добавить" onClick='location.href="{!! route('add-child',['parent' => $parent]) !!}"'>
                                </div>
                            </div>
                        </form>
                    </div>
