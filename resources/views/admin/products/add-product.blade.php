                    ...
                    <div class="demo-form-wrapper">
                        <form action="/add-product" method="post" class="form form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="form-control-1" class="form-control" type="text" name="packing_en" value="" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="form-control-1" class="form-control" type="text" name="atx" value="" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="form-control-1" class="form-control" type="text" name="file" value="" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="form-control-1" class="form-control" type="text" name="franko" value="" >
                                </div>
                            </div>
                            </p>
                            <div class="form-group">
